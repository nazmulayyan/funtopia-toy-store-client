        ...
        <div className='lg:max-w-screen-2xl py-10 mb-36 px-5'>
            ...
            <div className=''>
                <div className='grid md:grid-cols-3 grid-cols-1 pt-36 gap-12'>
                    <div className='border shadow-xl rounded-xl duration-200 hover:shadow-none text-center px-10 pt-10 pb-10'>
                        <img className='w-80 h-80 -mt-28 m-auto' src={img1} alt="" />
                        <h5 className='text-xl font-bold pt-10'>Toy Name: Diddy Knong</h5>
                    </div>
                    <div className='border shadow-xl rounded-xl duration-200 hover:shadow-none text-center px-10 pt-10 pb-10 md:mt-0 mt-28'>
                ...
                <div className='grid md:grid-cols-3 grid-cols-1 pt-36 gap-12'>
                    <div className='border shadow-xl rounded-xl duration-200 hover:shadow-none text-center px-10 pt-10 pb-5'>
